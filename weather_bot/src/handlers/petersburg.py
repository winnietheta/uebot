...
async def petersburg(message: types.CallbackQuery):
    ...
    hw_message = await message.answer("<b>🌆 Санкт-Петербург. Температура: ||weather['current']['temperature_2m']|| градусов Цельсия</b>", reply_markup=keyboards.cities().as_markup())
